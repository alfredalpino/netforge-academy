    ...
    steps: [
      {
        ...
        title: "Focus Timer",
        body: "Each study block has a timer. Work through theory → config → lab → break/fix → recall.",
        placement: "bottom",
      },
      {
        id: "focus-blocks",
        ...
        title: "Study Blocks",
        body: "Switch blocks as you progress. Mark each complete — it updates your streak and progress.",
        placement: "right",
      },
    ],
  },
